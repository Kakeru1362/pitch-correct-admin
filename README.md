...
- `tsunashima-outlook.html` — 綱島を本命とした購入判断レポート＋金利/インフレと不動産価格の見通し（2026-06-14版）
  - 金利・インフレが物件価格を動かす構造（需要側↓ vs 供給/原価側↑）、日銀の金利見通し、東京/神奈川の二極化見通し、綱島の上昇要因 vs 下落要因の対決
  - 3つの独立リサーチ（金利・市場全体・綱島）を相互検証して統合。金利別の借入可能額シミュレーション等を Chart.js で可視化
